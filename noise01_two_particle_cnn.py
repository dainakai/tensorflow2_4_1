...
far_train_path = glob.glob("./datasets/holograms/train/fft_far_holo/num_00001/*")
close_test_path = glob.glob("./datasets/holograms/test/fft_close_holo/num_00001/*")
far_test_path = glob.glob("./datasets/holograms/test/fft_far_holo/num_00001/*")
...
# close_train_path = close_train_path[0:1000]
# far_train_path = far_train_path[0:1000]
...
model = Sequential()
model.add(Conv2D(32, (7,7), input_shape=(HEIGHT,WIDTH,1)))
